...
from .uniform_parkour_command import UniformParkourCommand, UniformPIEVelocityCommand
...
@configclass
class PIEVelocityCommandCfg(CommandTermCfg):
    class_type: type = UniformPIEVelocityCommand
    asset_name: str = MISSING
