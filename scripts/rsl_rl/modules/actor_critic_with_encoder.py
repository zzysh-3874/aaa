...
class SimpleActorCritic(nn.Module):
    """Minimal feed-forward actor-critic for flat policy observations."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(f"Simple Actor MLP: {self.actor}")
        print(f"Simple Critic MLP: {self.critic}")
    ...
    def _actor_mean(self, observations):
        ...
        if self.action_limit is None:
            return mean
        return torch.tanh(mean) * float(self.action_limit)
