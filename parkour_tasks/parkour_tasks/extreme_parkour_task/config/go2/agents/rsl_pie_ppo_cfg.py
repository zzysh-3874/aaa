...
class UnitreeGo2PIESTARTFootHmapLowAdaGapOnlyStage2PPORunnerCfg(
    ...
    gap-traversal learning curve can be inspected frequently, the AdaSmpl
    anneal window is stretched to a 30000-iter run (9000..24000), and the
    exploration-noise ceiling is raised 0.40 -> 0.80 to break the gap-crossing
    exploration deadlock."""

    save_interval = 500
    estimator = ParkourRslRlPIESTARTFootHmapLowAdaGapOnly30kEstimatorCfg()
    policy = ParkourRslRlPIESTARTFootHmapGapOnlyActorCriticCfg()
